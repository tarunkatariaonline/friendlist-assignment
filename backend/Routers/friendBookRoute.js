...
router.post('/api/v1/friendbook/sendfriendrequest/:friendid',userAuth,sendFriendRequest)
router.get('/api/v1/friendbook/friendlist/:id',userAuth,friendList)

router.post('/api/v1/friendbook/acceptfriendrequest/:friendid',userAuth,acceptfriendrequest)
router.post('/api/v1/friendbook/rejectfriendrequest/:friendid',userAuth,rejectFriendRequest)
